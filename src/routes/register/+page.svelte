	...
	<div class="my-auto border border-slate-200 mx-auto bg-white rounded-md ...">
        <div class="p-8">
            ...
            <div class="text-center mb-4">
                <Button buttonText="register" onClick={register}></Button>    
            </div>
            ...
            {/if}
            <p class="text-center">Already a user? <a class="text-teal-900 font-semibold underline" href="login">Login</a></p>
        </div>
    </div>
</div>